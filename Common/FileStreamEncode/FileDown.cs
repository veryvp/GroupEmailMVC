...
namespace Common.FileStreamEncode
{
    ...
    public class FileDown
    {
        ...
        /// <param name="_Response">Page.Response对象</param>
        public static void BigFileDownload(string FileName, string FilePath, HttpResponse _Response)
        {
            ...
            string filepath = System.Configuration.ConfigurationManager.AppSettings["FileRoot"] + FilePath;
            ...
            try
            {
                ...
                _Response.ContentType = "application/octet-stream";
                _Response.AddHeader("Content-Disposition", "attachment; filename=" + System.Web.HttpUtility.UrlEncode(FileName));//System.Text.UTF8Encoding.UTF8.GetBytes(FileName)  
