...
namespace Common.FileStreamEncode
{
    ...
    public class WebClient
    {
        ...
        public string Post(string posturl, System.Collections.Hashtable HT)
        {
            string postData = "";
            foreach (DictionaryEntry de in HT)
            {
                postData = postData + "&" + de.Key.ToString() + "=" + System.Web.HttpContext.Current.Server.UrlEncode(de.Value.ToString());
            }
