...
namespace DAL
{
    public class DALRestSharpLog : BaseDAL
    {
        ...
        /// <returns>实体类Model.RestSharpLog</returns>
        ...
        /// <summary>
        /// 表Model.RestSharpLog添加一条数据
        /// </summary>
        /// <param name="M">Model.RestSharpLog实体</param>
        ...
        /// 表Model.RestSharpLog添加一条数据
        /// </summary>
        /// <param name="Model">Model.RestSharpLog实体</param>
        /// <returns>新增结果</returns>
        ...
        /// <returns>新的实体类Model.RestSharpLog若权限不足则返回null</returns>
        ...
        /// <summary>
        /// 根据Hashtable更新Model.RestSharpLog数据
        /// </summary>
        ...
        /// <summary>
        /// 根据MyHashTable更新Model.RestSharpLog数据
        /// </summary>
        ...
        /// </summary>
        /// <param name="Permissions">权限类别0: UserId 1: ParentId 2: UserId和ParentId 3: UserId或ParentId 4: 无附加条件</param>
        /// <returns>RestSharpLog的List集合</returns>
