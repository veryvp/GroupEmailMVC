...
namespace DAL
{
    public class DALVmoneyDetailNew : BaseDAL
    {
        ...
        /// <summary>
        /// 根据Id获取一条Model.VmoneyDetailNew数据
        /// </summary>
        ...
        /// <returns>实体类Model.VmoneyDetailNew</returns>
        ...
        /// <summary>
        /// 将实体类Model.VmoneyDetailNew转换成Json
        /// </summary>
        ...
        /// <summary>
        /// 表Model.VmoneyDetailNew添加一条数据
        /// </summary>
        /// <param name="M">Model.VmoneyDetailNew实体</param>
        ...
        /// 表Model.VmoneyDetailNew添加一条数据
        /// </summary>
        /// <param name="Model">Model.VmoneyDetailNew实体</param>
        /// <returns>新增结果</returns>
        ...
        /// <returns>新的实体类Model.VmoneyDetailNew若权限不足则返回null</returns>
        ...
        /// <summary>
        /// 根据Hashtable更新Model.VmoneyDetailNew数据
        /// </summary>
        ...
        /// <summary>
        /// 根据Model更新Model.VmoneyDetailNew数据
        /// </summary>
        ...
        /// <summary>
        /// 根据MyHashTable更新Model.VmoneyDetailNew数据
        /// </summary>
        ...
        /// <summary>
        /// 根据Json更新Model.VmoneyDetailNew数据
        /// </summary>
		...
		/// <summary>
        /// 表Model.VmoneyDetailNew添加或删除一条数据
        /// </summary>
        /// <param name="Ht">需要添加的Hashtable</param>
		/// <param name="Permissions">权限类别0:UserId 1:ParentId 2:UserId和ParentId 3:UserId或ParentId 4:无附加条件</param>
		/// <param name="Check">是否验证</param>
        ...
        /// </summary>
        /// <param name="Permissions">权限类别0: UserId 1: ParentId 2: UserId和ParentId 3: UserId或ParentId 4: 无附加条件</param>
        /// <returns>VmoneyDetailNew的List集合</returns>
